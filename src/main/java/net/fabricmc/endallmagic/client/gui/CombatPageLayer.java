...
import net.fabricmc.endallmagic.api.client.ClientUtil;
...
public class CombatPageLayer extends PageLayer {
	...
	static {
		...
		// 	return Text.translatable("endallmagic.gui.page.combat.text.attack_speed", ClientUtil.FORMATTING_2.format(value)).formatted(Formatting.DARK_GRAY);
		// }, value -> {
		// 	List<Text> tooltip = new ArrayList<>();

		// 	tooltip.add((Text.translatable("endallmagic.gui.page.combat.tooltip.attack_speed[0]")).formatted(Formatting.GRAY));
		// 	tooltip.add((Text.translatable("endallmagic.gui.page.combat.tooltip.attack_speed[1]")).formatted(Formatting.GRAY));
		...
		// 	return Text.translatable("endallmagic.gui.page.combat.text.attack_damage", ClientUtil.FORMATTING_2.format(value)).formatted(Formatting.DARK_GRAY);
		// }, value -> {
		// 	List<Text> tooltip = new ArrayList<Text>();

		// 	tooltip.add((Text.translatable("endallmagic.gui.page.combat.tooltip.attack_damage[0]")).formatted(Formatting.GRAY));
		// 	tooltip.add((Text.translatable("endallmagic.gui.page.combat.tooltip.attack_damage[1]")).formatted(Formatting.GRAY));
		...
		// 	return Text.translatable("endallmagic.gui.page.combat.text.armor", ClientUtil.FORMATTING_2.format(value)).formatted(Formatting.DARK_GRAY);
		// }, value -> {
		// 	List<Text> tooltip = new ArrayList<>();

		// 	tooltip.add((Text.translatable("endallmagic.gui.page.combat.tooltip.armor[0]")).formatted(Formatting.GRAY));
		// 	tooltip.add((Text.translatable("endallmagic.gui.page.combat.tooltip.armor[1]")).formatted(Formatting.GRAY));
		...
		// 	return Text.translatable("endallmagic.gui.page.combat.text.armor_toughness", ClientUtil.FORMATTING_2.format(value)).formatted(Formatting.DARK_GRAY);
		// }, value -> {
		// 	List<Text> tooltip = new ArrayList<>();
		// 	tooltip.add((Text.translatable("endallmagic.gui.page.combat.tooltip.armor_toughness[0]")).formatted(Formatting.GRAY));
		// 	tooltip.add((Text.translatable("endallmagic.gui.page.combat.tooltip.armor_toughness[1]")).formatted(Formatting.GRAY));
		// 	tooltip.add(Text.translatable("endallmagic.gui.page.combat.tooltip.armor_toughness[0]").formatted(Formatting.GRAY));
		// 	tooltip.add(Text.translatable("endallmagic.gui.page.combat.tooltip.armor_toughness[1]").formatted(Formatting.GRAY));
